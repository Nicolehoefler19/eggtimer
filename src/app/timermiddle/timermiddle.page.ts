...
@Component({
  selector: 'app-timermiddle',
  templateUrl: './timermiddle.page.html',
  styleUrls: ['./timermiddle.page.scss'],
})
export class TimermiddlePage implements OnInit {
